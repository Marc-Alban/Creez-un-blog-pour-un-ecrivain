...
<form class="formT col-12" method="post" enctype="multipart/form-data">
    ...
    <div class="form-group">
        ...
        <div class="col-md-4">
            <input id="chapitre_title" name="title" type="text" placeholder="titre" class="form-control input-md">
    ...
    <div class="d-flex justify-content-center">
        <button type="submit" name="post" class="btn btn-primary">Envoyer</button>
    </div>
</form>